...
* ✅ **主页信息流**：移除主页干扰视线的横幅与推荐广告。
* ✅ **支付页广告**：拦截支付宝洗澡小程序内的第三方推广。
* ✅ **流氓跳转**：彻底封锁洗澡结束时自动跳转淘宝闪购的行为。
...
打开本项目中的 [`rules.yaml`](./rules.yaml) 文件，复制其中的全部规则。
...
本规则仅供学习交流使用，请勿用于商业用途。由于拦截广告导致的任何功能异常，作者不承担相关责任。
